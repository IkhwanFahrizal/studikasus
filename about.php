...
<body>
    ...
    <center>
        ...
        <div class="section">
            <div class="container">
                <div class="box">
                    <p>Jual Laptop & Komputer Terbaik se-Indonesia Bergaransi Resmi | Pusat Belanja Komputer No.1 di Indonesia dengan banyak gerai 
                        dan tersebar di kota-kota besar </p>
                </div>
            </div>
        </div>
    </center>
